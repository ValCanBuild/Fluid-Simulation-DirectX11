...
Fluid3DSimulator::Fluid3DSimulator(Vector3 dimensions) : pD3dGraphicsObj(nullptr), 
	timeStep(TIME_STEP),
...
Fluid3DSimulator::~Fluid3DSimulator() {
	if (mPressureSP) {
		delete [] mPressureSP;
		mPressureSP = nullptr;
	}
...
bool Fluid3DSimulator::Initialize(_In_ D3DGraphicsObject* d3dGraphicsObj, HWND hwnd) {
...
void Fluid3DSimulator::ProcessEffect() {
...
void Fluid3DSimulator::Advect(ShaderParams *target) {
...
void Fluid3DSimulator::RefreshConstantImpulse() {
...
void Fluid3DSimulator::CalculatePressureGradient() {
...
void Fluid3DSimulator::SetGeneralBuffer() {
...
void Fluid3DSimulator::SetDissipationBuffer(float dissipation) {
	D3D11_MAPPED_SUBRESOURCE mappedResource;
...
void Fluid3DSimulator::SetImpulseBuffer(Vector4& point, Vector4& amount, float radius) {
	D3D11_MAPPED_SUBRESOURCE mappedResource;
...
ID3D11ShaderResourceView * Fluid3D::Fluid3DSimulator::GetVolumeTexture() const {
