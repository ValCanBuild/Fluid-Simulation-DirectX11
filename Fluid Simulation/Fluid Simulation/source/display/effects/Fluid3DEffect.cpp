/********************************************************************
Fluid3DEffect.cpp: Encapsulates a 3D fluid effect being calculated on the
GPU. 
...
Fluid3DEffect::Fluid3DEffect(Vector3 dimensions) : pD3dGraphicsObj(nullptr), 
	timeStep(TIME_STEP),
...
bool Fluid3DEffect::Initialize(_In_ D3DGraphicsObject* d3dGraphicsObj, HWND hwnd) {
...
void Fluid3DEffect::ProcessEffect() {
...
void Fluid3DEffect::Advect(ShaderParams *target) {
...
void Fluid3DEffect::RefreshConstantImpulse() {
...
void Fluid3DEffect::CalculatePressureGradient() {
...
void Fluid3DEffect::SetGeneralBuffer() {
...
void Fluid3DEffect::SetDissipationBuffer(float dissipation) {
	D3D11_MAPPED_SUBRESOURCE mappedResource;
...
void Fluid3DEffect::SetImpulseBuffer(Vector4& point, Vector4& amount, float radius) {
	D3D11_MAPPED_SUBRESOURCE mappedResource;
...
ID3D11ShaderResourceView * Fluid3D::Fluid3DEffect::GetVolumeTexture() const {
