...
///////FLUID3DRENDERSHADER BEGIN////////
Fluid3DRenderShader::Fluid3DRenderShader() {
}

Fluid3DRenderShader::~Fluid3DRenderShader() {
}

bool Fluid3DRenderShader::Compute(_In_ D3DGraphicsObject* graphicsObject, _In_ ID3D11ShaderResourceView* targetToRender, _In_ ID3D11UnorderedAccessView* result) {
	ID3D11DeviceContext *context = graphicsObject->GetDeviceContext();
...
ShaderDescription Fluid3DRenderShader::GetShaderDescription() {
	ShaderDescription shaderDescription;
...
///////FLUID3DRENDERSHADER SHADER END////////