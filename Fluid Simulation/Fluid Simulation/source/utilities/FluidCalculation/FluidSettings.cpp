...
void InitType() {
	TwStructMember fluidSettingsStructMembers[] = {
		...
		{ "Density Weight", TW_TYPE_FLOAT, offsetof(FluidSettings, densityWeight), "min=0.05 max=10.0 step=0.001" },
		{ "Density Buoyancy", TW_TYPE_FLOAT, offsetof(FluidSettings, densityBuoyancy), "min=0.0 max=100.0 step=0.001" },
		{ "Input Radius", TW_TYPE_FLOAT, offsetof(FluidSettings, constantInputRadius), "min=0.05 max=10.0 step=0.1" },
